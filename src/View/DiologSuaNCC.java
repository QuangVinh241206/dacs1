 ...
 * @author vinhn
 */
public class DiologSuaNCC extends javax.swing.JDialog {

    /**
     * Creates new form DiologThemNCC
     */
    int ID=0;
    public DiologSuaNCC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if (txtDiaChi.getText().trim().isEmpty()
            ...
            ncc.setMaNCC(ID);
            if (new NhaCungCapDAO().SuaNCC(ncc)) {
    ...
    public void setEditData(NhaCungCap ncc){
